...
#include <stdbool.h>
#include <assert.h>
#include "第十七組_B094020022郭向恬_B097610007王靖_B104020001徐雩芷 _B104020002劉和媛_程設期末專案_DrinkStruct.h"
#include "第十七組_B094020022郭向恬_B097610007王靖_B104020001徐雩芷 _B104020002劉和媛_程設期末專案_Clerk.h"
#include "第十七組_B094020022郭向恬_B097610007王靖_B104020001徐雩芷 _B104020002劉和媛_程設期末專案_Game.h"
#include "第十七組_B094020022郭向恬_B097610007王靖_B104020001徐雩芷 _B104020002劉和媛_程設期末專案_SetPoint.h"
...
void makeBeverage(int n, char item_name[][BOUGHT_BEV_LEN], char comb[]) {
	...
	while (i < n) {
		fp = fopen("第十七組_B094020022郭向恬_B097610007王靖_B104020001徐雩芷 _B104020002劉和媛_程設期末專案_RECIPE.txt","r");
		assert(fp != NULL);	
		while(fscanf(fp, "%s %[^\n]%*c", name, recipe) != EOF) {
